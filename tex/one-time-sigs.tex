...
\begin{exercise}
  ...
  Give an example for a one time signature scheme that is correct and $\pr{\game{\Game~\algo{G}}{\algo{OTS}} = 1} = negl$ for all \ppt adversaries $\adv$ but is not EUF-CMA secure.
\end{exercise}
...
\begin{exercise}[Optional]
  Explore the Winternitz One-Time Signature scheme, which achieves more compact signatures than Lamport signatures, by reading Sections 2.2, Theorem 1, and 3.2 of Hülsing~\cite{AFRICACRYPT:Hulsing13}.
  What challenges does the security reduction embed, and how are they embedded?
\end{exercise}
