  ...
  \begin{center}
    \begin{tcolorbox}[width=\textwidth]
      \begin{pchstack}[center]
        ...
        \pchspace
        \begin{pcvstack}
          \procedure[headlinesep=1pt]{$\bdv^{\pcoracle{H}_{\mathsf{sig}}}(\gamechange{$\gparam, X;$} \rho)$}{%
            \gamechange{$\params \defeq (\gparam, \{0,1\}^*, \GG \times \ZZ_p)$} \\
            T_{\mathsf{com}} \defeq \emptyset \\
            \gamechange{$\pcreturn \adv^{\pcoracle{S2CSign}_{\bdv}, \pcoracle{H}_{\mathsf{sig}}, \pcoracle{H}_{\mathsf{com},\bdv}}(\params, X; \rho)$}
          }
          \pcvspace
          \procedure[headlinesep=1pt]{Oracle $\pcoracle{S2CSign}_{\bdv}(m, m_C)$}{%
            \gamechange{$\sigma \gets \pcoracle{Sign}(m)$}\\
            \gamechange{$c_C \sample \ZZ_p$}\\
            \gamechange{$(R, s) \gets \sigma$}\\
            \gamechange{$R_C := R \cdot g^{-c_C}$}\\
            \gamechange{$\pcassert T_{\mathsf{com}}[R_C, m_C] = \bot$} \\
            \gamechange{$T_{\mathsf{com}}[R_C, m_C] := c_C$}\\
